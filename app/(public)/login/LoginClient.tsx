...
export default function LoginClient() {
  ...
  useEffect(() => {
    if (errors.email && formState.email) setErrors((p) => ({ ...p, email: undefined }));
    if (errors.password && formState.password) setErrors((p) => ({ ...p, password: undefined }));
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setFormState((p) => ({ ...p, isSubmitting: true, successMessage: null }));
    setErrors({});
      ...
      <div className="w-full max-w-md">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`pl-10 pr-4 py-3 w-full rounded-xl border bg-white/60 dark:bg-gray-900/60 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 transition-all ${errors.email ? 'border-rose-300 dark:border-rose-700 focus:ring-rose-500' : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500'}`}
                required
                autoComplete="email"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`pl-10 pr-10 py-3 w-full rounded-xl border bg-white/60 dark:bg-gray-900/60 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 transition-all ${errors.password ? 'border-rose-300 dark:border-rose-700 focus:ring-rose-500' : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500'}`}
                required
            ...
            <label className="inline-flex items-center gap-3 cursor-pointer">
              <div className="relative">
                <input
                  ...
                  disabled={formState.isSubmitting}
                />
                <div className={`w-5 h-5 rounded border-2 transition-all ${formState.rememberMe ? 'bg-blue-600 border-blue-600' : 'bg-white border-gray-300 dark:bg-gray-800 dark:border-gray-600'}`}>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            >
              Create one now <span aria-hidden="true">→</span>
            </Link>
          </p>
        </div>
      </div>
